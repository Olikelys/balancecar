...
#define OLED_RST_Clr() PAout(4)=0   //RST
#define OLED_RST_Set() PAout(4)=1   //RST

//#define OLED_RS_Clr() PAout(15)=0    //DC
//#define OLED_RS_Set() PAout(15)=1    //DC

#define OLED_RS_Clr() PBout(0)=0    //DC
#define OLED_RS_Set() PBout(0)=1    //DC

#define OLED_CS_Clr() PBout(0)=0    //CS
#define OLED_CS_Set() PBout(0)=1    //CS
